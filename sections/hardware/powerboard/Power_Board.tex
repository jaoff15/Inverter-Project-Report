...
The thermal resistance of the copper layer, is calculated from equation \ref{Rcopper}

    \begin{equation}
        R_{copper} = \frac{t_{copper}}{A_{MOSFET} \cdot k_{copper}} 
        \label{Rcopper}
    \end{equation}
    
Where $t_{copper}$ is the thickness of the copper layer in $m$, $A_{MOSFET}$ is the surface area of the MOSFET in $m^2$, and $k_{copper}$ is the thermal conduction constant for copper in $\frac{W}{m \cdot K}$.
The thickness is known to be $1 oz/foot^2$ from 'pcbway.com', which is converted to $34 \cdot 10^{-6} m$ from the density of copper. The area of the surface area of the MOSFET is found in the data sheet to be $63 \cdot 10^{-6} m^2$.\cite{mosfet} The thermal conduction constant of copper is $401 \frac{W}{m \cdot K}$.\cite{toolbox}

The thermal resistance of the dielectrical layer is calculated based on the same equation as \ref{Rcopper}.

    \begin{equation}
        R_{del} = \frac{t_{del}}{A_{MOSFET} \cdot k_{del}} 
        \label{Rdel}
    \end{equation}

Where $t_{del}$ is the thickness of the dielectrical layer in $m$, and $k_{del}$ is the thermal conduction constant for the dielectrical layer in $\frac{W}{m \cdot K}$.
The thickness of the dielectrical layer is stated by the manufactore, pcbway.com, to be $100 \mu m$. The thermal conduction constant is chosen to be $1 \frac{W}{m \cdot K}$. The manufacture offers also the aluminum PCB with a dielectrical layer with a thermal conduction constant of $2 \frac{W}{m \cdot K}$, but due to price this was not chosen.

The same equation is used again for calculating the thermal resistance of the aluminum layer of the PCB.

    \begin{equation}
        R_{alu} = \frac{t_{alu}}{A_{MOSFET} \cdot k_{alu}} 
        \label{Ralu}
    \end{equation}
    
The thickness of the aluminum layer, $t_{alu}$, is the chosen PCB thickness of $0.8 mm$ minus the thickness of the two other layers. The thickness of $0.8 mm$ is chosen because that is the thinnest option without getting the PCB more expensive. The thermal conduction constant for aluminum, $k_{alu}$, is $236 \frac{W}{m \cdot K}$.\cite{toolbox}
